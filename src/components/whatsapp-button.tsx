		...
		<button
			...
			className={
				floating
					...
					: "inline-flex items-center gap-2 rounded-full bg-[#25D366] px-5 py-3 text-sm font-semibold text-white shadow-sm transition-all duration-300 hover:bg-[#1fba59] active:scale-95"
			}
		>
