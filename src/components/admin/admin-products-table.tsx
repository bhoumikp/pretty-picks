...
export default function AdminProductsTable({
  ...
  return (
    <div className="soft-card relative rounded-2xl p-0">
      {isLoading && (
                    ...
                    <td className="px-5 py-4">
                      <div className="flex justify-end gap-2">
                        ...
                        >
                          ...
                          <span className="pointer-events-none absolute -top-9 right-0 hidden whitespace-nowrap rounded-md border border-[var(--pp-border)] bg-white px-2 py-1 text-xs text-[var(--pp-ink)] opacity-0 shadow-sm transition group-hover:block group-hover:opacity-100">
                            Edit
                          </span>
                        </Link>
                        <button
