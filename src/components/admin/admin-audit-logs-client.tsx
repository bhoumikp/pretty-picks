	...
	return (
		<div className="grid gap-4">
			<div className="flex flex-wrap items-center justify-between gap-3">
				<div>
					<p className="text-xs uppercase tracking-[0.2em] text-[var(--pp-muted)]">System</p>
					<div className="flex items-center gap-2">
						<h2 className="text-2xl font-[var(--font-heading)]">Audit Logs</h2>
						<button
							type="button"
							onClick={() => fetchLogs(query, page, sort, dir, action, entity, { force: true })}
							disabled={loading}
				...
				<div className="flex w-full flex-col gap-2 sm:flex-1 sm:flex-row sm:items-center sm:justify-end">
					<div className="flex w-full flex-wrap items-end gap-2 sm:max-w-[32rem]">
