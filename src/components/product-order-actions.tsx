  ...
  return (
    <div className="mt-8 space-y-5">
      <div className="flex flex-wrap items-center gap-4">
        <div className="flex items-center gap-3 rounded-xl border border-[var(--pp-border)] px-3 py-2 text-sm">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="rounded-lg bg-green-500 px-6 py-3 text-sm font-semibold text-white transition-all duration-300 hover:bg-green-600"
      ...
      <div className="grid gap-3 text-xs text-[var(--pp-muted)] sm:grid-cols-3">
        {["Secure packaging", "Fast delivery", "Affordable pricing"].map((item) => (
          <div
            key={item}
            className="rounded-xl border border-[var(--pp-border)] bg-[var(--pp-beige)] px-3 py-2 text-center"
          >
            {item}
          </div>
        ))}
      </div>
      <div className="fixed bottom-0 left-0 right-0 z-40 border-t border-[var(--pp-border)] bg-white p-4 md:hidden">
        <div className="flex items-center justify-between">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="rounded-lg bg-green-500 px-5 py-3 text-sm font-semibold text-white"
